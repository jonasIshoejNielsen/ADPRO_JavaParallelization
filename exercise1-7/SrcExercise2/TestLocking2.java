...
class DoubleArrayList {
  ...
  public synchronized static DoubleArrayList newInstance() {
  ...
  public boolean add(double x) {
    ...
    items[size] = x;
    size++;
    synchronized (DoubleArrayList.class) {totalSize++;}
    return true;
  }
  ...
  public synchronized static HashSet<DoubleArrayList> allLists() {
    return allLists;
  }
}
